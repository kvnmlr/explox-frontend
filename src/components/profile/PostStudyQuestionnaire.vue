<template>
  <section v-if="lang === 'en'">
    ...
    <v-container v-else fluid style="width: 100%;">
      <v-stepper v-model="e1" v-if="user">
        <v-stepper-header>
        ...
        <v-stepper-items>
          <v-stepper-content step="0">
            <v-layout column style="margin-left: 20px;">
              ...
              <p>Please decide spontaneously. Don’t think too long about your decision to make sure that you convey your
                original impression.
                Sometimes you may not be completely sure about your agreement with a particular attribute or you may
                find that the attribute does not apply completely to the particular product. Nevertheless, please tick a
          ...
          <v-stepper-content step="1" v-if="user">
            <v-layout column style="margin-left: 20px;">
              ...
              <br>
              <p class="title">Did the website help you in finding new cycling routes? Would you like to continue using
                ExploX to find new cycling routes?</p>
              <v-textarea v-model="feedback.q3"></v-textarea>
              <br>
              <p class="title">Did you actually cycle some of the generated routes? If yes, please provide links to the
              ...
              <v-btn v-if="feedback.q1 + feedback.q2 +feedback.q3 +feedback.q4 +feedback.q5 !== ''"
                class="gradient gradient-orange" style="width: 200px;" dark round @click="e1 = 2"
                     v-on:click="logUser">Submit
              </v-btn>
              <v-btn v-else disabled style="width: 400px;" round @click="e1 = 1"
          ...
          <v-stepper-content step="2" v-if="user">
            <v-layout column style="margin-left: 20px;">
              ...
              <br>
              <div class="text">We will choose the winners of the vouchers on 05. August and will let you know via email
